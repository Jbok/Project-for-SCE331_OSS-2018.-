...
<br>
Tesseract와 OpenCV 모두 오픈소스이기 때문에 여러 개발자들에 의해 각각의 성능이 개선된다면 더 나은 영상처리와 문자인식을 보여줄 것이고,<br>
그에 따라 우리가 개발하는 영상을 대상으로 한 문자 인식 오픈소스의 성능 역시 향상될 가능성이 존재한다.<br>
<br>
또한, 우리 팀이 최초로 기획했던 스포츠 중계에서의 적용 뿐만 아니라 다른 분야에서도 응용될 수 있다.<br>
웹 브라우저의 확장기능의 형태로 영상의 문자 인식이 가능한 오픈 소스를 이용한 서비스를 개발할 수 있다. <br>
예를 들어, 사용자가 게임과 관련된 영상을 재생할 경우 게임과 관련된 정보를 보여준다거나, 음악방송을 재생할 경우 해당 가수에 대한 정보를 제공하는 등 <br>
개발자는 이용자가 재생하는 임의의 영상의 종류에 따라서 무궁무진한 서비스를 개발하여 제공할 수 있을 것이다. <br>
<br>
